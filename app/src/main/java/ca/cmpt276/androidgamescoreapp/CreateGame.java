...
public class CreateGame extends AppCompatActivity {
    ...
    int p1Cards, p1Points, p1Wagers, p1Score;
    int p2Cards, p2Points, p2Wagers, p2Score;
    EditText p1CardsInput, p1PointsInput, p1WagersInput;
    EditText p2CardsInput, p2PointsInput, p2WagersInput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Sets title if a game is being updated and sets time
        ...
        p1CardsInput = (EditText) findViewById(R.id.player1_cards);
        p1PointsInput = (EditText) findViewById(R.id.player1_points);
        p1WagersInput = (EditText) findViewById(R.id.player1_wagers);
        player1_score = (TextView) findViewById(R.id.player1_score);

        p2CardsInput = (EditText) findViewById(R.id.player2_cards);
        p2PointsInput = (EditText) findViewById(R.id.player2_points);
        p2WagersInput = (EditText) findViewById(R.id.player2_wagers);
